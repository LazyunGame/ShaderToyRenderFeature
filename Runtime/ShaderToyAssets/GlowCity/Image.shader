Shader "ShaderToy/GlowCity/Image"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float streetDistance = 0.6;
            vec3 streetColor = vec3(4.0, 8.0, 10.0);

            float fogDensity = 0.5;
            float fogDistance = 4.0;
            vec3 fogColor = vec3(0.34, 0.37, 0.4);

            float windowSize = 0.1;
            float windowDivergence = 0.2;
            vec3 windowColor = vec3(0.1, 0.2, 0.5);

            float beaconProb = 0.0003;
            float beaconFreq = 0.6;
            vec3 beaconColor = vec3(1.5, 0.2, 0.0);
